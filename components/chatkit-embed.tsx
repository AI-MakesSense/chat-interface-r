...
// ChatKit only supports: 'sparkle' | 'lightbulb' | 'mail' | 'phone' | 'calendar' | 'globe' | 'search' | 'star' | 'check' | 'info' | 'compass' | 'map-pin' | 'user' | 'write' | 'document' | 'book-open' | 'bug' | 'cube' | 'bolt' | 'chart' | 'keys' | 'notebook' | 'profile'
